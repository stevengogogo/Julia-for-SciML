...
Julia (https://julialang.org/) is a generic programming language designed for high performance computing, and an open source project under MIT license. Julia language is aimed to solve the "two language problem" that typical occurs in scientific computing. Julia is dynamically typed like scripting language such as Python, and can be compiled to native machine code. Besides, composablility via multiple dispatch makes Julia works well on the integration across packages. The SciML (https://sciml.ai/) is an open source software for scientific machine learning based on Julia language, that combines machine learning and scientific computing together by integrating numerous standalone packages.
